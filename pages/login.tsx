...
export default function Login(){
    ...
    const page={
      ...
      useTitleAsH1:false,
      useNavBar:false,
      description:`${appName} Login Page is use to login in app.`           
    }    
    return (    
        <>
            <Head>
            ...
            >
                <div className="lg:flex">
                    <div className="lg:w-1/2 xl:max-w-screen-sm">
                        <div className="py-12 bg-indigo-100 md:bg-transparent flex justify-center lg:justify-start lg:px-12">
                            <div className="cursor-pointer flex  justify-center ">                            
                                <div className="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold"><Link href="/">{appName}</Link></div>
                            </div>
                        </div>
                        <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                            ...
                            <form className="mb-4">
                                    <div className="mb-4">
                                        ...
                                        <input className="shadow appearance-none border border-red-500 mb-3 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Username"/>
                                        <p className="text-red-500 text-xs italic">Please enter a valid username.</p>
                                    </div>
                                    <div className="mb-6">
                                        <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="password">
                                            Password
                                        </label>
                                        <input className="shadow appearance-none border border-red-500 mb-3 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="password" type="password" placeholder="******************"/>
